...
---
= Recupera i file di supporto al ripristino in SANtricity System Manager
:allow-uri-read: 
:experimental: 
:icons: font
:imagesdir: ../media/
...
.Fasi
. Dal pannello di sinistra, selezionare menu:Support[Support Center > Diagnostics] tab.
