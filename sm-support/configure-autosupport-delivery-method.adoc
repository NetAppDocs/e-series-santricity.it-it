...
---
= Configurare il metodo di consegna AutoSupport in SANtricity System Manager
:allow-uri-read: 
:experimental: 
:icons: font
:imagesdir: ../media/
...
====
.Fasi
. Dal pannello di sinistra, selezionare menu:Supporto [Support Center > AutoSupport] scheda.
