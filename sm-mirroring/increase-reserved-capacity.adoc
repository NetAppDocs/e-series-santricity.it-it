...
. Seleziona l'oggetto storage per il quale desideri aumentare la capacità riservata, quindi fai clic sull'icona menu:ellipsis icon[Aumenta capacità riservata].
+
Viene visualizzata la pagina Increase Reserved Capacity.
