...
---
= Scopri di più sulla proprietà del volume nel mirroring sincrono nel software SANtricity
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[NOTE]
====
Questa funzione non è disponibile per il mirroring sincrono sui sistemi storage EF80, EF50, EF600/EF600C o EF300/EF300C.
