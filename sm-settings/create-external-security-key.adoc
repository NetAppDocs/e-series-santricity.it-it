...
** *Seleziona il file della chiave privata* -- Se necessario, fai clic sul secondo pulsante *Browse* per selezionare un file di chiave privata per i controller dell'array di storage.
