...
---
= Modificare le mappature dei ruoli SAML in SANtricity System Manager
:allow-uri-read: 
:experimental: 
:icons: font
:imagesdir: ../media/
...
.Fasi
. Dal pannello di sinistra, selezionare menu:Settings[Access Management].
. Selezionare la scheda *SAML*.
. Seleziona *Map System Manager roles*.
+
