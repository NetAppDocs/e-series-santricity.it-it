...
È possibile configurare gli avvisi dalla procedura guidata di configurazione iniziale (solo per gli avvisi email) oppure dalla pagina Alerts. Per accedere alla pagina Alerts, vai su menu:Settings[Alerts] dal pannello di sinistra.
