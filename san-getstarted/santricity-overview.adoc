...
NOTE: Gli array di storage EF80, EF50, EF600/EF600C e EF300/EF300C non supportano il mirroring sincrono o i volumi thin.
...
Unified Manager è un software basato sul web utilizzato per gestire l'intero dominio. Da una vista centrale, puoi vedere lo stato di tutti i più recenti array E-Series ed EF-Series, come EF80, EF50, E4000, E2800, EF280, EF300, E5700, EF570, EF600, EF300C ed EF600C. Puoi anche eseguire operazioni batch sugli array di storage selezionati.
