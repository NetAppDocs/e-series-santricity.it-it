...
---
= Requisiti per l'utilizzo del mirroring in SANtricity Unified Manager
:allow-uri-read: 
:experimental: 
:icons: font
:imagesdir: ../media/
...
[NOTE]
====
Il mirroring sincrono non è disponibile sugli array di storage EF80, EF50, EF600/EF600C o EF300/EF300C.
...
NOTE: I controller E4000 non supportano il mirroring iSCSI.
...
* I volumi primario e secondario non devono avere il partizionamento delle risorse abilitato.
