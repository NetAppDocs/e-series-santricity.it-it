...
[NOTE]
====
Questa funzione non è disponibile sui sistemi storage EF80, EF50, EF600/EF600C o EF300/EF300C.
...
.Al termine
Accedere a System Manager e al menu:Storage[Operazioni in corso] per visualizzare lo stato di avanzamento dell'operazione di mirroring sincrono. Questa operazione può essere lunga e potrebbe influire sulle prestazioni del sistema.
