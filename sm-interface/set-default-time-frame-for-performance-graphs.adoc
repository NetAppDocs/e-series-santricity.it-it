...
.Fasi
. Fai clic sull'icona *User Settings* nell'angolo in alto a destra della finestra.
. Nell'elenco a discesa Default performance graphs time range to show, seleziona *5 minuti*, *1 ora*, *8 ore*, *1 giorno* o *7 giorni* e conferma che desideri eseguire l'operazione.
