...
.Fasi
. Dal pannello di sinistra, seleziona *Home*.
. Fai clic sull'icona *Bell* e poi sul collegamento etichettato *Recover from _n_ problems* nella parte superiore centrale della finestra.
+
...
+
Il file viene salvato nella cartella Downloads del tuo browser con il nome `recoveryGuru-failureName-arrayName-yyyy-mm-dd-hh-mm-ss.html`.
