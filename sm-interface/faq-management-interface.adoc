...
Il grafico della latenza fornisce statistiche sulla latenza, in millisecondi (ms), per volumi, gruppi di volumi, pool, applicazioni e carichi di lavoro. Questo grafico viene visualizzato nelle schede Logical View, Physical View e Applications and workloads View.
...
Il grafico IOPS visualizza statistiche relative alle operazioni di input/output al secondo. Nella pagina Home, questo grafico visualizza statistiche per lo storage array. Nelle schede Logical View, Physical View e Applications and workloads View della pagina Performance, questo grafico visualizza statistiche per lo storage array, i volumi, i gruppi di volumi, i pool, le applicazioni e i carichi di lavoro.
...
Il grafico MiB/s visualizza le statistiche sulla velocità di trasferimento in mebibyte al secondo. Nella pagina Home, questo grafico visualizza le statistiche per lo storage array. Nelle schede Logical View, Physical View e Applications and workloads View della pagina Performance, questo grafico visualizza le statistiche per lo storage array, i volumi, i gruppi di volumi, i pool, le applicazioni e i carichi di lavoro.
...
Il grafico Headroom si riferisce alla capacità prestazionale residua per i controller dell'array di storage. Questo grafico è visibile nella pagina Home e nella scheda Physical View della pagina Performance.
