...
. Seleziona il gruppo di volumi che desideri modificare, quindi fai clic sull'icona menu:ellipsis icon[Edit Settings].
+
Viene visualizzata la finestra Edit Volume Group Settings.

. Modifica le impostazioni del gruppo di volume come appropriato.
+
.Dettagli del campo
[%collapsible]
====
