...
. Seleziona il volume del membro del gruppo di coerenza che desideri modificare, quindi fai clic sull'icona menu:ellipsis icon[Edit Settings].
+
Viene visualizzata la finestra Modifica volume membro del gruppo di coerenza.
...
Soglia di allarme capacità riservata piena
 a| 
Utilizzare la barra per regolare il punto percentuale in cui System Manager invia una notifica di avviso quando la capacità riservata per un volume membro sta per esaurirsi.
