...
* È inoltre possibile accedere al menu:Storage[Pool e gruppi di volumi] dal pannello di sinistra e quindi selezionare il menu:ellipsis icon[Consolidate volume group free capacity] per avviare la finestra di dialogo.
