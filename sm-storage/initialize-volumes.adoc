...
. Fare clic sull'icona menu:ellipsis [Initialize volumes].
+
...
Selezionare menu:Storage[Operazioni in corso] per visualizzare l'avanzamento dell'operazione di inizializzazione attualmente in esecuzione per il volume selezionato. Questa operazione può essere lunga e potrebbe influire sulle prestazioni del sistema.
