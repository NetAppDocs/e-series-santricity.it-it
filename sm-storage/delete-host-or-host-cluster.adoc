...
---
= Eliminare un host o un cluster di host in SANtricity System Manager
:allow-uri-read: 
:experimental: 
:icons: font
:imagesdir: ../media/
...
. Seleziona l'host o il cluster che desideri eliminare, quindi fai clic sull'icona menu:ellipsis icon[Delete].
+
