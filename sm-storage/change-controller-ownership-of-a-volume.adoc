...
. Fai clic sull'icona menu:ellipsis [Change volume ownership].
+
Viene visualizzata la finestra Cambia proprietario del volume. Tutti i volumi presenti sul sistema storage vengono visualizzati in questa finestra di dialogo.
