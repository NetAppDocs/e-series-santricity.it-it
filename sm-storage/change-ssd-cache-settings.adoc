...
summary: 'È possibile modificare le impostazioni della Cache SSD. Le impostazioni correnti della Cache SSD sono accessibili tramite l"opzione Visualizza impostazioni.' 
---
...
[role="lead"]
È possibile modificare le impostazioni della Cache SSD. Le impostazioni correnti della Cache SSD sono accessibili tramite l'opzione Visualizza impostazioni.

.Fasi
. Dal pannello di sinistra, selezionare menu:Storage[Pool e gruppi di volumi].
. Seleziona la Cache SSD che desideri modificare, quindi fai clic sull'icona menu:ellipsis icon[Edit Settings].
+
Viene visualizzata la finestra Modifica impostazioni Cache SSD.
