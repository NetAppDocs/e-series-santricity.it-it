...
È possibile consentire a System Manager di creare automaticamente i pool quando rileva capacità non assegnata in un array di storage. In alternativa, quando la creazione automatica non può determinare la configurazione migliore, è possibile creare i pool manualmente dal menu:Storage[Pools and volume groups].
...
È possibile creare gruppi di volumi dal menu:Storage[Pool e gruppi di volumi].
