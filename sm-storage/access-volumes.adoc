...
---
= Volumi di accesso in SANtricity System Manager
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[NOTE]
====
La gestione in banda tramite il volume Access non è disponibile per i sistemi storage EF80, EF50, E4000, EF600/EF600C o EF300/EF300C.
