...
Resource Provisioning Capable (solo EF80, EF50, EF300 e EF600)
 a| 
Indica se Resource Provisioning è disponibile per questo gruppo. Resource Provisioning è una funzionalità disponibile negli array di storage EF80, EF50, EF300 e EF600, che consente di mettere in uso i volumi immediatamente senza alcun processo di inizializzazione in background.
