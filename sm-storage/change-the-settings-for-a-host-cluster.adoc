...
. Seleziona il cluster host che desideri modificare, quindi fai clic sull'icona menu:ellipsis [Edit Settings].
+
Viene visualizzata una finestra che mostra le impostazioni correnti del cluster host.
