...
+
** Dal pannello di sinistra, selezionare menu:Storage[Volumes]. Selezionare l'oggetto (volume di base o snapshot consistency group), quindi fare clic sul menu:ellipsis icon[Create instant snapshot].
** Dal pannello di sinistra, selezionare menu:Storage[Snapshots]. Selezionare la scheda *Snapshot Images* e quindi selezionare menu:Create[Instant snapshot Image].
+
