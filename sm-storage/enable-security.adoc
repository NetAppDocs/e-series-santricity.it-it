...
. Seleziona il pool o il gruppo di volumi su cui desideri abilitare la sicurezza, quindi fai clic su menu:icona con i puntini di sospensione[Abilita sicurezza].
+
