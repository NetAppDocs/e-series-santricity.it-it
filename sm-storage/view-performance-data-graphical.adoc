...
* *Vista Applications and workloads* -- Visualizza un elenco di oggetti logici (volumi) raggruppati in base ai tipi di applicazione e ai carichi di lavoro che hai definito.
...
. Seleziona la scheda *Logical View*, la scheda *Physical View* o la scheda *Applications and workloads View*.
+
...
** *Dischi*: Latenza, IOPS, MiB/s.
 ...
 a| 
Visualizzazione applicazioni e carichi di lavoro
 a| 
** *Storage array*: IOPS, MiB/s.
