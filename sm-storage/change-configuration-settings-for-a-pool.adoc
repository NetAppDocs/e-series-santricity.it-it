...
. Seleziona il pool che desideri modificare, quindi fai clic sull'icona menu:ellipsis icon[Edit Settings].
+
Viene visualizzata la finestra Edit pool Setting.

. Modifica le impostazioni del pool secondo necessità.
+
.Dettagli del campo
[%collapsible]
====
