...
+
Se non è disponibile capacità libera nel pool o nel gruppo di volumi che contiene l'oggetto di storage selezionato e lo storage array presenta Unassigned Capacity, puoi aggiungere capacità. Puoi creare un nuovo pool o volume group e riprovare questa operazione utilizzando la nuova capacità libera su quel pool o volume group.
