...
. Seleziona l'oggetto di storage per cui vuoi diminuire la capacità riservata, quindi fai clic sull'icona menu:ellipsis icon[Decrease Capacity].
+
Viene visualizzata la pagina Decrease Reserved Capacity.
