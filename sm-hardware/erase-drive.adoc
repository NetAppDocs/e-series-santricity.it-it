...
====
. Dal menu contestuale, seleziona *Cancella unità*.
+
...
. Conferma l'operazione digitando `erase`, quindi fai clic su *Cancella unità*.
+
[CAUTION]
====
...
.Risultati
L'operazione di cancellazione potrebbe richiedere da diversi minuti a diverse ore. Puoi visualizzare lo stato in menu:Storage[Operazioni in corso]. Quando l'operazione di cancellazione è completata, le unità sono disponibili per l'uso in un altro gruppo di volumi o pool di dischi, oppure in un altro storage array.
