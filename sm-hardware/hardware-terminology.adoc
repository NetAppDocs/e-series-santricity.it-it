...
DULBE
 a| 
Deallocated or Unwritten Logical Block Error (DULBE) è un'opzione sulle unità NVMe che consente all'array di storage EF80, EF50, EF300/EF300C o EF600/EF600C di supportare volumi con provisioning delle risorse.
