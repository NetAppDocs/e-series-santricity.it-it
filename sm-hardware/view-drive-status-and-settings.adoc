...
Compatibile con DULBE
 a| 
Indica se l'opzione per Deallocated or Unwritten Logical Block Error (DULBE) è abilitata (Sì) o no (No). DULBE è un'opzione sulle unità NVMe che consente all'array di storage EF80, EF50, EF300 o EF600 di supportare volumi con provisioning delle risorse.
